...
:: Use a distinct filename from morning_launcher.py's own FileHandler
:: (morning_YYYYMMDD.log) — Windows won't let both processes open the same
:: file, which caused a PermissionError at startup.
set LOG_FILE=%LOG_DIR%\task_morning_%dt:~0,8%.log
